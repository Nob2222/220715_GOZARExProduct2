...
final class Bluetooth: NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate, ReplyStreamDelegate {
    ...
    let SERVICE_UUID_STR = "00002220-0000-1000-8000-00805F9B34FB"
    let CHARACT_UUID_STR = "00002222-0000-1000-8000-00805F9B34FB"
    ...
    func write(data:Data) {
        ...
        while remain > 0 {
            ...
            print(data.subdata( in:index..<index+wlen ))
